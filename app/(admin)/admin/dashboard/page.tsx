...
export default function AdminDashboardPage() {
  ...
  const statCards = [
    ...
    { label: 'Total Rows',   value: stats?.totalRows    ?? '—', icon: ListChecks,    color: 'text-cyan-600 bg-cyan-100 dark:bg-cyan-950/60' },
    { label: 'Messages',     value: stats?.totalMessages ?? '—', icon: MessageSquare, color: 'text-amber-600 bg-amber-100 dark:bg-amber-950/60' },
