...
import { Search, BookOpen, Inbox, MessageSquare, X, Table2 } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Search across notes, inbox, messages, and lists.</p>
      </div>
